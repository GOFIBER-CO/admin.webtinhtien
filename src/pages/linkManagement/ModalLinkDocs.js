...
const ModalLinkDocs = ({ isModalOpen, handleOk, handleCancel }) => {
    ...
    const getData = async ()=>{
        try {
            const res = await fetch("https://sheet.best/api/sheets/59a8f2d1-c71f-4fd9-833f-d180a7cb41e2")
            // console.log(res, 'res');
    ...
    >
      ...
      >
        ...
        <p style={{ color: "orange" }}>
          Lưu ý: Link google docs phải chuẩn định dạng google document. Nếu vẫn có lỗi
